...
import {
  Zap, Github, Star, GitFork, Users, BookOpen,
...
const REPOS = [
  { name: "bannerforge", desc: "GitHub README animated banner generator with 100+ presets", stars: 142, forks: 28, lang: "TypeScript", updated: "2025-05-28" },
  { name: "reactor-core", desc: "Reactive state management library for React applications", stars: 204, forks: 31, lang: "TypeScript", updated: "2025-05-15" },
  { name: "neural-cache", desc: "Distributed in-memory cache with ML-driven eviction policies", stars: 89, forks: 12, lang: "Go", updated: "2025-05-22" },
  { name: "rusty-pipe", desc: "High-performance data pipeline framework built in Rust", stars: 67, forks: 9, lang: "Rust", updated: "2025-05-18" },
  { name: "airo-ml", desc: "Lightweight ML inference engine optimized for edge devices", stars: 56, forks: 8, lang: "Python", updated: "2025-05-10" },
  { name: "sveltos", desc: "Kubernetes-native configuration sync operator", stars: 38, forks: 5, lang: "Go", updated: "2025-05-05" },
];

const EVENTS = [
  { icon: GitCommit, repo: "bannerforge", time: "2h ago", detail: "pushed 3 commits to main", color: "#0066FF" },
  { icon: GitPullRequest, repo: "reactor-core", time: "5h ago", detail: "opened PR #47: Add middleware pipeline", color: "#00E676" },
  { icon: AlertCircle, repo: "neural-cache", time: "8h ago", detail: "opened issue #12: Memory leak on TTL expiry", color: "#FF4081" },
  { icon: GitBranch, repo: "airo-ml", time: "1d ago", detail: "created branch feat/onnx-support", color: "#FFD700" },
  { icon: GitCommit, repo: "rusty-pipe", time: "1d ago", detail: "pushed 5 commits to main", color: "#0066FF" },
  { icon: GitFork, repo: "bannerforge", time: "2d ago", detail: "forked to dev-user-42", color: "#00E676" },
  { icon: Star, repo: "reactor-core", time: "3d ago", detail: "starred reactor-core", color: "#FFD700" },
  { icon: GitCommit, repo: "sveltos", time: "3d ago", detail: "pushed 2 commits to feat/cluster-sync", color: "#0066FF" },
  { icon: GitMerge, repo: "neural-cache", time: "4d ago", detail: "merged PR #8: Add Redis backend", color: "#00E676" },
  { icon: AlertCircle, repo: "rusty-pipe", time: "5d ago", detail: "closed issue #3: Buffer overflow on large input", color: "#FF4081" },
  { icon: GitCommit, repo: "airo-ml", time: "6d ago", detail: "pushed 4 commits to main", color: "#0066FF" },
  { icon: Star, repo: "bannerforge", time: "1w ago", detail: "starred by opencode-ai", color: "#FFD700" },
];
          ...
          <div className="xl:grid xl:grid-cols-12 xl:gap-8">
            ...
            <aside className="xl:col-span-3 pt-8 xl:pt-16 xl:sticky xl:top-24 xl:self-start">
              ...
              >
                ...
                />
                <div className="scanline absolute left-0 right-0 h-[2px] bg-[#0066FF] opacity-70 pointer-events-none z-10"
              ...
              <div className="text-center xl:text-left mb-8">
                <h1 className="font-['Syne',sans-serif] text-3xl xl:text-4xl font-black uppercase tracking-tight text-foreground leading-none mb-1 break-words">
                  {USER.name}
                </h1>
            ...
            <main className="xl:col-span-9 pt-8 xl:pt-16 pb-20 space-y-16">
              ...
              <section>
                <div className="relative overflow-hidden border border-border/10 p-8 md:p-12 bg-card">
                  ...
                  <div className="flex flex-wrap gap-4 items-center">
                    <a href={USER.url} target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-6 py-3 font-['JetBrains_Mono',monospace] text-sm font-bold text-foreground bg-[#0066FF] hover:bg-[#0052CC] transition-all active:translate-x-[2px] active:translate-y-[2px]"
                    ...
                    <a href={`${USER.url}?tab=repositories`} target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-6 py-3 font-['JetBrains_Mono',monospace] text-sm text-foreground/70 border border-border/20 hover:bg-muted/30 transition-all active:translate-x-[2px] active:translate-y-[2px]"
                    >
              ...
              <section>
                ...
                <div className="border border-border/10 bg-card p-6 md:p-8">
                  ...
                  <div className="grid grid-cols-7 gap-1.5 max-w-[400px] mx-auto">
                    {CELLS.map((c, i) => {
              ...
              <section>
                ...
                <div className="border border-border/10 bg-card overflow-hidden">
                  ...
                  <div className="divide-y divide-border/[0.03] max-h-[400px] overflow-y-auto custom-scrollbar">
                    {EVENTS.map((e, i) => (
                      <div key={i}
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <Zap className="w-16 h-16 md:w-20 md:h-20 text-[#0066FF]"
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href={USER.url} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-3.5 font-['JetBrains_Mono',monospace] text-sm font-bold text-foreground bg-[#0066FF] hover:bg-[#0052CC] transition-all active:translate-x-[2px] active:translate-y-[2px]"
                style={{ boxShadow: "6px 6px 0px 0px rgba(0,102,255,0.4)" }}
              >
                <Github className="w-4 h-4" /> TRANSMIT — CONNECT
              </a>
              <Link href="/"
                className="inline-flex items-center gap-2 px-8 py-3.5 font-['JetBrains_Mono',monospace] text-sm text-foreground/50 border border-border/20 hover:text-foreground hover:border-foreground/40 transition-all active:translate-x-[2px] active:translate-y-[2px]"
              >
